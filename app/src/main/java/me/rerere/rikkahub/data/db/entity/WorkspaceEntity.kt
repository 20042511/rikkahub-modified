...
data class WorkspaceEntity(
    ...
    @ColumnInfo("environment", defaultValue = "PROOT")
    val environment: String = WorkspaceEnvironment.PROOT.name,
    ...
    fun toWorkspace(): Workspace = Workspace(
        ...
        environment = runCatching { WorkspaceEnvironment.valueOf(environment) }
            .getOrDefault(WorkspaceEnvironment.PROOT),
    )
}
